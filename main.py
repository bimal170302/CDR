    ...
    main_layout = html.Div(
        children=[
            html.Div(id='heading-div', children=[
                ...
                style={'background': '#360b5a', 'padding': 10}),html.Br(),

            dcc.Tabs(id="Tabs", value="Call Analytics tool", children=[

                dcc.Tab(label="Call Analytics tool", id="Call Analytics tool", style=tab_style,value="Call Analytics tool", selected_style = tab_selected_style,
                        children=[
                            html.Br(),
                            dcc.Dropdown(
                ...
                dcc.Tab(label="Device Analytics tool",
                        id="Device Analytics tool", style = tab_style,value="Device Analytics tool", selected_style = tab_selected_style,
                        children = [
                            html.Br(),
                ...
                dcc.Tab(label="Service Analytics tool", id="Service Analytics tool", style = tab_style, value="Service Analytics tool", selected_style = tab_selected_style,
                        children = [
                            html.Br(),
